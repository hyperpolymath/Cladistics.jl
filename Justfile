...
doctor:
    @echo "Running diagnostics for Cladistics.jl..."
...
help-me:
    @echo "=== Cladistics.jl Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/Cladistics.jl/issues/new"
    @echo ""
