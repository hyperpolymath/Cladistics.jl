...
= Contributing — Cladistics.jl
:toc: left

Contributions to `Cladistics.jl` follow the Hyperpolymath estate conventions:
...
[source,bash]
----
git clone git@github.com:hyperpolymath/Cladistics.jl.git
cd Cladistics.jl
