...
git clone <https://github.com/hyperpolymath/Cladistics.jl.git> cd
Cladistics.jl
...
toolbox create Cladistics.jl-dev toolbox enter Cladistics.jl-dev \#
...
Cladistics.jl/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/ \#
...
flake (Perimeter 1) └── Justfile \# Task runner (Perimeter 1)
    ...
    **When suggesting**:
    ...
    - [`good first issue`](https://github.com/hyperpolymath/Cladistics.jl/labels/good%20first%20issue) — Simple Perimeter 3 tasks
    - [`help wanted`](https://github.com/hyperpolymath/Cladistics.jl/labels/help%20wanted) — Community help needed
    - [`documentation`](https://github.com/hyperpolymath/Cladistics.jl/labels/documentation) — Docs improvements
    - [`perimeter-3`](https://github.com/hyperpolymath/Cladistics.jl/labels/perimeter-3) — Community sandbox scope
